...
public final class ProxyProvider {
    ...
    private static final int VERIFY_TIMEOUT_MS = 450;
    ...
    public synchronized Optional<ProxyEndpoint> acquireVerifiedProxy() {
        for (int round = 0; round < 2; round++) {
            ...
            while (!candidates.isEmpty()) {
                ...
                if (isReachable(endpoint)) {
                    ...
                    LOGGER.info("Using {} proxy {} for AFK bot join", endpoint.type(), endpoint.key());
                    return Optional.of(endpoint);
                }
            }
        }
        LOGGER.warn("No live public proxy found; AFK bot join will use the normal direct route.");
    ...
    private boolean isReachable(ProxyEndpoint endpoint) {
